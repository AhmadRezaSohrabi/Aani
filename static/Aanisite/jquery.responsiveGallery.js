		...
		function getTransform5CSS(){
			...
			if(support3d){
				cssArray = [
					...
					getTransform3dCSS('50%', 	50, 	35,		0,	1,	'visible'),
					getTransform3dCSS('100%', 	100, 	35,		1,	1,	'visible'),
					getTransform3dCSS('200%', 	400, 	0,		2,	1,	'visible'),
					getTransform3dCSS('300%', 	100, 	-35,	1,	1,	'visible'),
					getTransform3dCSS('350%', 	50, 	-35,	0,	1,	'visible'),
